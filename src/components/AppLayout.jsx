...
export default function AppLayout({ children }) {
  ...
  return (
    <div className="bg-surface font-body text-on-surface min-h-screen flex">
      ...
      <aside className="w-16 bg-white/80 backdrop-blur-xl border-r border-slate-200/60 flex flex-col items-center py-4 gap-1 sticky top-0 h-screen z-40 shrink-0">
        {/* Aurea3D Logo */}
